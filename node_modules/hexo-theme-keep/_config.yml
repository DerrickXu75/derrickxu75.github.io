...
style:
  ...
  first_screen:
    ...
    description: Grau, teurer Freund, ist alle Theorie,||Und grün des Lebens goldner Baum.
  ...
  scroll:
    ...
    progress_bar: ture # Option values: true | false
...
social_contact:
  ...
  links:
    ...
    github: https://github.com/derrickxu1220         # GitHub
    weixin:          # WeChat
    qq:              # QQ
    weibo:           # WeiBo
    zhihu:           # ZhiHu
    twitter:         # Twitter
    facebook:        # Facebook
    email: tianyang.xu.cn@gmail.com # Email
